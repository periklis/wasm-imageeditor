...
function ImageProcessor() {
  this.ptr = _emscripten_bind_ImageProcessor_ImageProcessor_0();
  getCache(ImageProcessor)[this.ptr] = this;
};;
ImageProcessor.prototype = Object.create(WrapperObject.prototype);
ImageProcessor.prototype.constructor = ImageProcessor;
ImageProcessor.prototype.__class__ = ImageProcessor;
ImageProcessor.__cache__ = {};
Module['ImageProcessor'] = ImageProcessor;

ImageProcessor.prototype['dims'] = ImageProcessor.prototype.dims = function() {
  var self = this.ptr;
  _emscripten_bind_ImageProcessor_dims_0(self);
};;

ImageProcessor.prototype['histogram'] = ImageProcessor.prototype.histogram = function() {
  var self = this.ptr;
  _emscripten_bind_ImageProcessor_histogram_0(self);
};;

  ImageProcessor.prototype['__destroy__'] = ImageProcessor.prototype.__destroy__ = function() {
  var self = this.ptr;
  _emscripten_bind_ImageProcessor___destroy___0(self);
};
(function() {
  function setupEnums() {
